    ...
    render() {
                                                ...
                                                <>
                                                    ...
                                                    <td className="float-right">
                                                        <button
                                                            ...
                                                            onClick={() => this.props.history.push(`/completed-order/${p.id}`)}
                                                        >
                                                            <IoIosList />
                                                        </button>
                                                        <button
                                                            ...
                                                            onClick={() => this.props.history.push(`/delete-completed-order/${p.id}`)}
                                                        >
                                                            <GoTrashcan />
                                                        </button>
                                                    </td>
        ...
        return (
            <Layout>
                ...
                <h1 className="h3 mb-3 text-gray-800">Completed Orders</h1>
