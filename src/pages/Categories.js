                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="float-right">
                                            <button
                                                ...
                                                onClick={() => this.props.history.push(`/edit-category/${p.slug}`)}
                                            >
                                                <FiEdit2 />
                                            </button>
                                            <button
                                                ...
                                                onClick={() => this.props.history.push(`/delete-category/${p.slug}`)}
                                            >
                                                <GoTrashcan />
                                            </button>
                                        </td>
        ...
        return (
            <Layout>
                <div className="container-fluid">
                    <h1 className="h3 mb-3 text-gray-800">Categories</h1>
                        ...
                        <div className="card-body p-0">
                            <div className="d-flex mb-3 pb-3 border-bottom">
                                <button
                                    ...
                                    onClick={() => this.props.history.push('/create-category')}
                                >
                                    <GoPlus /> New Category
                                </button>
                            </div>
