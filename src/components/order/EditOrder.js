...
export default class EditOrder extends Component 
{
    ...
    handleOnSubmit = () => {
        ...
        .update({
            ...
            status_mm: this.state.status_mm
        })
                    ...
                    p ? (
                        <div key={p.id} className="mb-4">
                            <h1 className="h3 mb-4 text-gray-800">
                                ...
                                >
                                    <IoIosArrowRoundBack />
                                </button> Edit <IoIosArrowRoundForward /> {p.id}
                            </h1>
                            <div
                                className=""
                            >
                                ...
                                >
                                    ...
                                    <div className="col-12 col-lg-6 mb-4">
                                        <strong className="text-dark">အော်ဒါနံပါတ်</strong> - <strong className="text-primary"><i>{p.id}</i></strong>
                                    </div>
                                    <div className="col-12 col-lg-6 mb-4">
                                    ...
                                    <div className="col-12 mb-4">
                                        ...
                                        <div className="d-flex col-6 col-md-4 px-0 mt-2">
                                            <select
                                                name="status_mm"
                                                id="status_mm"
                                                value={this.state.status_mm}
                                                onChange={this.handleOnChange.bind(this)}
                                                className="mr-2 custom-select form-control rounded-sm shadow-none border-primary bg-transparent"
                                                style={{
                                                    height: '50px',
                                                    lineHeight: '2'
                                                }}
                                        ...
                                        <button
                                            className="mt-2 px-4 py-2 border-0 rounded-sm shadow btn btn-dark d-inline-block"
